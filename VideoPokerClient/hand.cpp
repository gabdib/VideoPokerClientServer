...
void Hand::handRankCount()
{
    ...
    for(i=0;i<13;i++)
    {
        ...
        if(hand[0].get_rank()==i-1) rankCount[i-1]++;
        if(hand[1].get_rank()==i-1) rankCount[i-1]++;
        if(hand[2].get_rank()==i-1) rankCount[i-1]++;
        if(hand[3].get_rank()==i-1) rankCount[i-1]++;
        if(hand[4].get_rank()==i-1) rankCount[i-1]++;
    }
}
